...
ACTIVATION-NOTICE: This file and the @.claude/agents/i18n.md file contain your full agent operating guidelines. DO NOT load any other external agent files.
...
activation-instructions:
    - STEP 1: Read THE ENTIRE FILE AGENT FILE @.claude/agents/i18n.md - it contains your complete persona definition
    ...
    - There are only 4 commands in total in the commands section below.
commands: # All commands require * prefix when used (e.g., *help)
    - help: Show numbered list of all 4 commands to allow selection
