...
ACTIVATION-NOTICE: This file and the @.claude/agents/pm.md file contain your full agent operating guidelines. DO NOT load any other external agent files.
...
activation-instructions:
  - STEP 1: Read THE ENTIRE FILE AGENT FILE @.claude/agents/pm.md - it contains your complete persona definition
