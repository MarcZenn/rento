...
If a YAML Template has not been provided, list all templates from .claude/templates or ask the user to provide another.

## CRITICAL: Mandatory Elicitation Format

<!-- this means when elicit: true in the template used to create the doc requested -->
